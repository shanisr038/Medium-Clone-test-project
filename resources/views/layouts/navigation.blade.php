<nav x-data="{ open: false }" class="bg-white border-b border-gray-100 shadow-sm">
            ...
            <div class="flex items-center space-x-4">
                ...
                @guest
                    ...
                    <div class="hidden sm:flex items-center space-x-4">
                        ...
                        <a href="{{ route('login') }}"
                            class="text-sm font-semibold text-gray-600 hover:text-gray-800 transition">
                            Login
                        </a>
                    </div>
                @endguest
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden bg-white border-t border-gray-200">
        ...
        @guest
            <div class="pt-4 pb-4 border-t border-gray-200 flex flex-col space-y-2 px-4">
                <!-- Create Post for Guest -->
                <a href="{{ route('login') }}">
                    <x-primary-button>+ Create Post</x-primary-button>
                </a>
